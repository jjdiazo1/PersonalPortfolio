      ...
      >
        ...
        >
          ...
          {lineText}
            ...
            <div className="absolute top-[30%] w-full overflow-hidden">
              <motion.div
          className={`whitespace-nowrap ${faintTextClass} font-extrabold text-4xl md:text-[6rem] uppercase`}
          {...lineVariantsRight}
              >
          {lineText}
            ...
            <div className="absolute top-[50%] w-full overflow-hidden">
              <motion.div
          className={`whitespace-nowrap ${faintTextClass} font-extrabold text-4xl md:text-[6rem] uppercase`}
          {...lineVariantsLeft}
              >
          {lineText}
            ...
            <div className="absolute top-[70%] w-full overflow-hidden">
              <motion.div
          className={`whitespace-nowrap ${faintTextClass} font-extrabold text-4xl md:text-[6rem] uppercase`}
          {...lineVariantsRight}
              >
        ...
        >
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {/* Job 1 */}
              <div className={`border ${borderClass} p-6 flex hover:scale-[1.02] transition-transform`}>
                ...
                {/* Logo frame */}
                <div className={`w-1/3 flex items-center justify-center border-l ${borderClass}`}>
                  <div className={`h-16 w-16 border ${borderClass} flex items-center justify-center text-xs uppercase`}>Logo</div>
                </div>
              </div>
        ...
        >
          ...
          >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
              {["Python", "Java", "Webflow", "Pytorch", "UI & Graphic Design", "Video editing", "Photography", "React"].map((skill) => (
                <div key={skill} className={`border ${borderClass} p-4 hover:scale-[1.02] transition-transform`}>
                  <p className="font-bold uppercase text-xs">{skill}</p>
                </div>
              ))}
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {[
                ...
                <div key={lang} className={`border ${borderClass} p-6 hover:scale-[1.02] transition-transform text-center`}>
                  <h3 className="font-bold text-md uppercase">{lang}</h3>
                  <p className="text-xs uppercase font-light">{level}</p>
                </div>
              ))}
            </div>
          </motion.div>
